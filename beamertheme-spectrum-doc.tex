...
\tcbset{
  run latexmk-dev/.style={run@system@command={latexmk -g- -lualatex -pdflualatex=lualatex-dev  -cd  }{#1}},%
}
...
There is also an experimental \saminline|xbeamer| version of the spectrum theme. It works similarly, but does not offer a \saminline|standout| frame option.
\begin{tcblisting}{
  listing and comment,
  pdf comment,
  freeze pdf,
